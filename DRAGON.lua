...
if [ ! $token ]; then
echo "┄─━━ʀᴏɢᴇɴ━━─┄ ┄─━━ʀᴏɢᴇɴ━━─┄ ┉ ┉"
echo -e "\e[1;36mTOKEN IS NOT FIND IN FILE ma_k.lua \e[0m"
echo "┄─━━ʀᴏɢᴇɴ━━─┄ ┉ ┉ ┉ ┉┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉┉ ┉"
exit 1
fi
...
local config = loadfile("./ma_k.lua")() 
return config 
end 
_redis = load_redis()  
--------------------------------------------------------------------------------------------------------------
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/UUMARTEN/RO/main/File_Bot/commands.lua") 
...
os.execute('wget https://raw.githubusercontent.com/UUMARTEN/RO/main/DRAGON.lua')
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/UUMARTEN/RO/main/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/UUMARTEN/RO/main/File_Bot/"..file)
if res == 200 then
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[بلاش نكد بحبك 😁 ](t.me/SO_ROGEN)') 
return false
end
end
end
...
♻️التاريخ
┄─━━ʀᴏɢᴇɴ━━─┄
[♻️ 𝘴𝘰𝘶𝘳𝘤𝘦 𝘳𝘰𝘰𝘨𝘦𝘯 ♻️](t.me/SO_ROGEN)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
