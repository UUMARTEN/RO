...
if [ ! $token ]; then
echo " ┄─━━━━𝗿𝗼𝗼𝗴𝗲𝗻━━━━─┄  ┄─━━━━𝗿𝗼𝗼𝗴𝗲𝗻━━━━─┄"
echo -e "\e[1;36mTOKEN IS NOT FIND IN FILE mkklInfo.lua \e[0m"
echo " ┄─━━━━𝗿𝗼𝗼𝗴𝗲𝗻━━━━─┄  ┄─━━━━𝗿𝗼𝗼𝗴𝗲𝗻━━━━─┄"
exit 1
fi
...
local f = io.open("./mkklInfo.lua", "r")  
if not f then   
AutoSet()  
else   
f:close()  
...
local config = loadfile("./mkklInfo.lua")() 
return config 
end 
_redis = load_redis()  
--------------------------------------------------------------------------------------------------------------
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/ELKABOOOS/RROOGGEENN/main/File_Bot/commands.lua") 
...
if tonumber(user_id) == tonumber(1851380322) then  
var = 'مـبـرمـج سـورس روجـيـن'
elseif tonumber(user_id) == tonumber(1839082644) then
var = 'مـبـرمـج سـورس روجـيـن'
elseif tonumber(user_id) == tonumber(1744196893) then
var = 'مــطـور سـورس روجـيـن'
elseif tonumber(user_id) == tonumber(SUDO) then
var = 'المطور الاساسي'  
elseif database:sismember(bot_id.."Dev:SoFi:2", user_id) then
var = "المطور الثانوي"  
...
if Chat_Type == 'UserBot' then
if not DevSoFi(msg) then
if text == '/start' or text == '•`𝑏𝑎𝑐𝑘´•'  then  
local bl = '•`𝑏𝑎𝑐𝑘´•'
local keyboard = {
{'قـسم مـطورين الـسورس'},
{'قـسم الالـعـاب'},
...
--------------------------------------------------------------------------------------------------------------
if Chat_Type == 'UserBot' then
if text == '/start' or text == 'ʙᴀᴄᴋ☆' then  
...
os.execute('wget https://raw.githubusercontent.com/ELKABOOOS/RROOGGEENN/main/BANDA.lua')
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝚍𝚎𝚟 𝚖𝚊𝚛𝚝𝚎𝚗',url="t.me/I_C_X"},{text = '𝚍𝚎𝚟 𝚊𝚕𝚖𝚊𝚐𝚔', url="t.me/M_A_G_K"}},
...
{{text = '𝚍𝚎𝚟 𝚎𝚕𝚔𝚊𝚋𝚘𝚘𝚜', url="t.me/G_W_P"}},
{{text = '𝚜𝚘𝚞𝚛𝚌𝚎 𝚛𝚘𝚘𝚐𝚎𝚗', url="t.me/SO_ROGEN"}},
{{text = '𝚝𝚠𝚊𝚜𝚘𝚘𝚕 𝚛𝚘𝚘𝚐𝚎𝚗',url="t.me/TW_ROGEN_BOT"}}, 
}
local msg_id = msg.id_/2097152/0.5
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/ELKABOOOS/RROOGGEENN/main/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/ELKABOOOS/RROOGGEENN/main/File_Bot/"..file)
if res == 200 then
...
zh = https.request('https://mostafabot.club/zrf.php?abs='..URL.escape(TextZhrfa)..'')
zx = JSON.decode(zh)
t = "\n  ◉قائمه الزخرفه \n ┄─━━━━𝗿𝗼𝗼𝗴𝗲𝗻━━━━─┄\n"
i = 0
...
UrlAntk = https.request('https://mostafabot.club/Antk.php?abs='..URL.escape(textntk)..'')   
