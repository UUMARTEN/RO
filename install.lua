...
local RunBot = io.open("ROGEN", 'w')
RunBot:write([[
#!/usr/bin/env bash
cd $HOME/ROGEN
token="]]..database:get(Server_Done.."Token_Write")..[["
rm -fr ROGEN.lua
wget "https://raw.githubusercontent.com/ROGENTEAM/ROGEN/main/ROGEN.lua"
while(true) do
rm -fr ../.telegram-cli
./tg -s ./ROGEN.lua -p PROFILE --bot=$token
done
]])
RunBot:close()
...
while(true) do
rm -fr ../.telegram-cli
screen -S ROGEN -X kill
screen -S ROGEN ./ROGEN
done
]])
RunTs:close()
end
