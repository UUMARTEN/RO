...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/ROGENTEAM/Files_ROGEN/main/File_Bot/commands.lua") 
...
if hash or SudoBot(msg) or DevROGENW(msg) or Sudo(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevROGENW(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevROGENW(msg) or Sudo(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevROGENW(msg) or Sudo(msg) or BasicConstructor(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevROGENW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevROGENW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevROGENW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
local ROGEN_Msg = ''  
if msgs < 100 then 
ROGEN_Msg = 'غير متفاعل' 
elseif msgs < 200 then 
ROGEN_Msg = 'بده يتحسن' 
elseif msgs < 400 then 
ROGEN_Msg = 'شبه متفاعل' 
elseif msgs < 700 then 
ROGEN_Msg = 'متفاعل' 
elseif msgs < 1200 then 
ROGEN_Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
ROGEN_Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
ROGEN_Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
ROGEN_Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
ROGEN_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
ROGEN_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
ROGEN_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
ROGEN_Msg = 'امبروطور التفاعل' 
elseif msgs < 10000000000 then 
ROGEN_Msg = 'رب التفاعل'  
end 
return ROGEN_Msg 
end
...
--------------------------------------------------------------------------------------------------------------
function SourceROGEN(msg,data) -- بداية العمل امـيـر الـ دلـيـم
if msg then
...
local list = database:smembers(bot_id.."ROGEN1:List:Filter"..sl)
...
if not DevROGENW(msg) and not database:sismember(bot_id..'Ban:User_Bot',msg.sender_user_id_) and not database:get(bot_id..'Tuasl:Bots') then
...
if DevROGENW(msg) and msg.reply_to_message_id_ ~= 0  then
...
send(msg.chat_id_, msg.id_,ROGEN_Msg) 
return false  
end 
if text then
...
if text == 'تفعيل التواصل ✫' and DevROGENW(msg) then  
...
if text == 'تعطيل التواصل ✫' and DevROGENW(msg) then  
...
if text == 'تفعيل البوت الخدمي ✫' and DevROGENW(msg) then  
...
if text == 'تعطيل البوت الخدمي ✫' and DevROGENW(msg) then  
...
if text == 'ضع كليشه ستارت ✫' and DevROGENW(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,' *✫︙ارسل لي الكليشه الان*')
return false
end
if text == 'حذف كليشه ستارت ✫' and DevROGENW(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,' *✫︙تم حذف كليشه ستارت*')
end
if text == 'معلومات السيرفر ✫' and DevROGENW(msg) then 
...
if text == 'تحديث السورس ✫' and DevROGENW(msg) then 
os.execute('rm -rf ROGEN.lua')
os.execute('wget https://raw.githubusercontent.com/ROGENTEAM/ROGEN/main/ROGEN.lua')
send(msg.chat_id_, msg.id_,' *✫︙تم تحديث السورس* \n*✫︙لديك اخر اصدار لسورس دريم لاند*\n*✫︙الاصدار » { 2.8v}*')
dofile('ROGEN.lua')  
end
if text == 'الاصدار ✫' and DevROGENW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' *✫︙اصدار سورس دريم لاند* \n*✫︙الاصدار »{ 2.8v}*')
end
if text == 'قناه تحديثات البوت ✫' and DevROGENW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ✫︙[تحديثات البوت](t.me/H_U_O_L) \n✫︙[قناه السورس](t.me/hi_z2)')
end
if text == "ضع اسم للبوت ✫" and DevROGENW(msg) then  
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_," *✫︙ارسل اليه الاسم الان* ")
return false
end
if text == 'الاحصائيات ✫' and DevROGENW(msg) then 
...
if text == 'المشتركين ✫' and DevROGENW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *✫︙المشتركين» {`'..Users..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == 'الكروبات ✫' and DevROGENW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *✫︙الكروبات» {`'..Groups..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == ("المطورين ✫") and DevROGENW(msg) then
...
if text == ("قائمه العام ✫") and DevROGENW(msg) then
...
if text == ("قائمه الكتم العام ✫") and DevROGENW(msg) then
...
if text=="اذاعه خاص ✫" and msg.reply_to_message_id_ == 0 and DevROGENW(msg) then 
database:setex(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *✫︙ارسل الان اذاعتك؟* \n*✫︙للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه ✫" and msg.reply_to_message_id_ == 0 and DevROGENW(msg) then 
database:setex(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *✫︙ارسل الان اذاعتك؟* \n*✫︙للخروج ارسل الغاء* ")
return false
end  
if text=="اذاعه بالتثبيت ✫" and msg.reply_to_message_id_ == 0 and DevROGENW(msg) then 
database:setex(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *✫︙ارسل الان اذاعتك؟* \n*✫︙للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه بالتوجيه ✫" and msg.reply_to_message_id_ == 0  and DevROGENW(msg) then 
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *✫︙ارسل لي التوجيه الان*")
return false
end 
if text=="اذاعه بالتوجيه خاص ✫" and msg.reply_to_message_id_ == 0  and DevROGENW(msg) then 
database:setex(bot_id.."Send:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ✫︙ارسل لي التوجيه الان")
return false
end 
if text == 'جلب نسخه الاحتياطيه ✫' and DevROGENW(msg) then 
GetFile_Bot(msg)
end
if text == "تنظيف المشتركين ✫" and DevROGENW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == "تنظيف الكروبات ✫" and DevROGENW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
send(msg.chat_id_, msg.id_,'*✫︙عدد الكروبات الان » { '..#group..' }'..ROGENk..''..ROGEN..'*\n*✫︙الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات*\n')   
end
end
end,nil)
end
...
if text and text:match("^رفع مطور @(.*)$") and DevROGENW(msg) then
...
if text and text:match("^رفع مطور (%d+)$") and DevROGENW(msg) then
...
if text and text:match("^تنزيل مطور @(.*)$") and DevROGENW(msg) then
...
if text and text:match("^تنزيل مطور (%d+)$") and DevROGENW(msg) then
...
local ROGEN1_Msg = database:get(bot_id.."ROGEN1:Add:Filter:Rp2"..text..msg.chat_id_)   
if ROGEN1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
--------------------------------------------------------------------------------------------------------------
if ROGEN_Msg and not Special(msg) then  
local ROGEN_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if ROGEN_Msg then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
...
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevROGENW(msg) then
...
if text and text:match("^ضع عدد الاعضاء (%d+)$") and DevROGENW(msg) then
...
if text and text:match("^تغير الاشتراك$") and DevROGENW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *✫︙حسنآ ارسل لي معرف القناة*')
return false  
end
if text and text:match("^تغير رساله الاشتراك$") and DevROGENW(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *✫︙حسنآ ارسل لي النص الذي تريده*')
return false  
end
if text == "حذف رساله الاشتراك ✫" and DevROGENW(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, " *✫︙تم مسح رساله الاشتراك* ")
return false  
end
if text and text:match("^وضع قناة الاشتراك ✫$") and DevROGENW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *✫︙حسنآ ارسل لي معرف القناة*')
return false  
end
if text == "تفعيل الاشتراك الاجباري ✫" and DevROGENW(msg) then  
if database:get(bot_id..'add:ch:id') then
...
if text == "تعطيل الاشتراك الاجباري ✫" and DevROGENW(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, " *✫︙تم تعطيل الاشتراك الاجباري* ")
return false  
end
if text == "الاشتراك الاجباري ✫" and DevROGENW(msg) then  
...
database:sadd(bot_id.."ROGEN:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."ROGEN:blocname"..msg.chat_id_)
...
if t2.id_ then 
name_ROGEN = ((t2.first_name_ or "") .. (t2.last_name_ or ""))
if name_ROGEN then 
names_ROGEN = database:smembers(bot_id.."ROGEN:blocname"..msg.chat_id_) or ""
if names_ROGEN and names_ROGEN[1] then 
for i=1,#names_ROGEN do 
if name_ROGEN:match("(.*)("..names_ROGEN[i]..")(.*)") then 
...
database:set(bot_id.."ROGEN:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."ROGEN:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."ROGEN:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."ROGEN:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."ROGEN:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function amir_ROGENa_new(ROGEN1,ROGEN2)
if ROGEN2 and ROGEN2.first_name_ then 
if ROGEN2.first_name_:match("(.*)"..database:get(bot_id.."ROGEN:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."ROGEN:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local ROGEN_nnn = database:get(bot_id.."ROGEN:nump"..msg.chat_id_) or 5
local ROGEN_nnn2 = database:get(bot_id.."ROGEN:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(ROGEN_nnn2) == tonumber(ROGEN_nnn) or tonumber(ROGEN_nnn2) > tonumber(ROGEN_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."ROGEN:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "✫︙عزيزي >>["..ROGEN2.username_.."](https://t.me/"..(ROGEN2.username_ or "hi_z2")..")\n✫︙عليك وضع التوحيد ⪼ {"..database:get(bot_id.."ROGEN:teh"..msg.chat_id_).."} بجانب اسمك\n✫︙عدد المحاولات المتبقيه {"..(tonumber(ROGEN_nnn) - tonumber(ROGEN_nnn2)).."}")
end
end
end
end
bnnaGet(id, amir_ROGENa_new)
end
end
...
local ROGENChengName = database:get(bot_id.."ROGEN:Cheng:Name"..data.id_)
if not data.first_name_ then 
if ROGENChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..ROGENChengName..']')
database:del(bot_id.."ROGEN:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if ROGENChengName ~= data.first_name_ then 
local Text = {
  "جان خوش اسم يول",
...
database:set(bot_id.."ROGEN:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local ROGENChengUserName = database:get(bot_id.."ROGEN:Cheng:UserName"..data.id_)
if not data.username_ then 
if ROGENChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..ROGENChengUserName..']')
database:del(bot_id.."ROGEN:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if ROGENChengUserName ~= data.username_ then 
local Text = {
...
database:set(bot_id.."ROGEN:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local ROGENChengPhoto = database:get(bot_id.."ROGEN:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if ROGENChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صور ابن الحلو شكد غبي لعد😂🥺")
database:del(bot_id.."ROGEN:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if ROGENChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
...
database:set(bot_id.."ROGEN:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)   
...
if text == 'رفع نسخه الاحتياطيه' and DevROGENW(msg) then   
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
------------------------------------------------------------------------ امـيـر الـدلـيـم
if text == 'تحديث' and DevROGENW(msg) then
dofile('ROGEN.lua')  
send(msg.chat_id_, msg.id_, ' *✫︙تم تحديث جميع الملفات*') 
end 
if text == ("مسح قائمه العام") and DevROGENW(msg) then
...
if text == ("حظر عام") and msg.reply_to_message_id_ and DevROGENW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
function start_function(extra, result, success)
if ROGENSudoBot(result.sender_user_id_) then
...
if text and text:match("^حظر عام @(.*)$")  and DevROGENW(msg) then
...
if ROGENSudoBot(result.id_) then
send(msg.chat_id_, msg.id_,"*✫︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
...
if text and text:match("^حظر عام (%d+)$") and DevROGENW(msg) then
...
if text == ("كتم عام") and msg.reply_to_message_id_ and DevROGENW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^كتم عام @(.*)$")  and DevROGENW(msg) then
...
if text and text:match("^كتم عام (%d+)$") and DevROGENW(msg) then
...
if text == ("الغاء العام") and msg.reply_to_message_id_ and DevROGENW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^الغاء العام @(.*)$") and DevROGENW(msg) then
...
if text and text:match("^الغاء العام (%d+)$") and DevROGENW(msg) then
...
------------------------------------------------------------------------ امـيـر الـدلـيـم
if text == ("مسح المطورين") and DevROGENW(msg) then
...
if text == 'الملفات' and DevROGENW(msg) then
...
if DevROGENW(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/ROGENTEAM/Files_ROGEN/main/getfile.json")
if res == 200 then
...
if text and text:match("^(تعطيل) (.*)(.lua)$") and DevROGENW(msg) then
...
local json_file, res = https.request("https://raw.githubusercontent.com/ROGENTEAM/Files_ROGEN/main/File_Bot/"..file)
if res == 200 then
...
if text and text:match("^(تفعيل) (.*)(.lua)$") and DevROGENW(msg) then
...
if text == "مسح الملفات" and DevROGENW(msg) then
os.execute("rm -fr File_Bot/*")
send(msg.chat_id_,msg.id_," *✫︙تم مسح الملفات*")
return false
end

if text == ("رفع مطور") and msg.reply_to_message_id_ and DevROGENW(msg) then
function start_function(extra, result, success)
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
...
if text == ("تنزيل مطور") and msg.reply_to_message_id_ and DevROGENW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
function Function_ROGEN(extra, result, success)
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_ROGEN, nil)
return false 
end
...
tdcli_function ({ID = "SearchPublicChat",username_ = username}, Function_ROGEN, nil)
return false 
end
...
local TexMKRG = {string.match(text, "^(كتم) (%d+) (.*)$")}
function start_function(extra, result, success)
if TexMKRG[3] == 'يوم' then
Time_Restrict = TexMKRG[2]:match('(%d+)')
Time = Time_Restrict * 86400
end
if TexMKRG[3] == 'ساعه' then
Time_Restrict = TexMKRG[2]:match('(%d+)')
Time = Time_Restrict * 3600
end
if TexMKRG[3] == 'دقيقه' then
Time_Restrict = TexMKRG[2]:match('(%d+)')
Time = Time_Restrict * 60
end
TexMKRG[3] = TexMKRG[3]:gsub('دقيقه',"دقايق") 
TexMKRG[3] = TexMKRG[3]:gsub('ساعه',"ساعات") 
TexMKRG[3] = TexMKRG[3]:gsub("يوم","ايام") 
if ROGENSudoBot(result.sender_user_id_) then
send(msg.chat_id_, msg.id_,"*✫︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *✫︙اسم المستخدم »* ['..data.first_name_..'](t.me/'..(data.username_ or 'hi_z2')..')'
status  = '\n*✫︙تم كتم لمدة ~* { '..TexMKRG[2]..' '..TexMKRG[3]..'}'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
...
tdcli_function ({ID = "SearchPublicChat",username_ = TexMKRG[4]}, start_function, nil)
return false
end
if text and text:match("^كتم (%d+)$") and Mod(msg) then
...
local TexMKRG = {string.match(text, "^(تقيد) (%d+) (.*)$")}
function start_function(extra, result, success)
if TexMKRG[3] == 'يوم' then
Time_Restrict = TexMKRG[2]:match('(%d+)')
Time = Time_Restrict * 86400
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *✫︙اسم المستخدم »* ['..data.first_name_..'](t.me/'..(data.username_ or 'hi_z2')..')'
status  = '\n*✫︙تم تقيده لمدة ~* { '..TexMKRG[2]..' '..TexMKRG[3]..'}'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
https.request("https://api.telegram.org/bot"..token.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id="..result.sender_user_id_..'&until_date='..tonumber(msg.date_+Time))
end
...
database:set(bot_id.."ROGEN1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."ROGEN1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," *✫︙ارسل التحذير عند ارسال الكلمه*")  
database:set(bot_id.."ROGEN1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."ROGEN1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."ROGEN1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."ROGEN1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," *✫︙تم منع الكلمه مع التحذير*")  
database:del(bot_id.."ROGEN1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."ROGEN1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."ROGEN1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."ROGEN1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," *✫︙ارسل الكلمه الان*")  
database:set(bot_id.."ROGEN1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."ROGEN1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."ROGEN1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."ROGEN1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."ROGEN1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."ROGEN1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."ROGEN1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."ROGEN1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."ROGEN1:List:Filter"..msg.chat_id_,v)  
end  
...
if text == 'مسح كليشه المطور' and DevROGENW(msg) then
database:del(bot_id..'TEXT_SUDO')
send(msg.chat_id_, msg.id_,' *✫︙تم مسح كليشه المطور*')
end
if text == 'ضع كليشه المطور' and DevROGENW(msg) then
...
if text == 'تفعيل الاذاعه' and DevROGENW(msg) then  
...
if text == 'تعطيل الاذاعه' and DevROGENW(msg) then  
...
send(msg.chat_id_, msg.id_,'['..ROGEN_Msg[math.random(#ROGEN_Msg)]..']') 
return false
end
if text=="اذاعه خاص" and msg.reply_to_message_id_ == 0 and Sudo(msg) then 
if database:get(bot_id..'Bc:Bots') and not DevROGENW(msg) then 
...
if ROGENSudoBot(msg.sender_user_id_) then
database:srem(bot_id..'DEV:Sudo:T', result.sender_user_id_)
database:srem(bot_id..'Sudo:User', result.sender_user_id_)
database:srem(bot_id..'CoSu'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Basic:Constructor'..msg.chat_id_,result.sender_user_id_)
...
if text == ("مسح ردود المطور") and DevROGENW(msg) then 
...
if text == ("ردود المطور") and DevROGENW(msg) then 
local list = database:smembers(bot_id..'List:Rd:Sudo')
text = "\n ✫︙قائمة ردود المطور \n*•━━━━━━ 𝘿𝙇 ━━━━━━━•*\n"
for k,v in pairs(list) do
...
if text == 'اضف رد للكل' and DevROGENW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'حذف رد للكل' and DevROGENW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'تفعيل المغادره' and DevROGENW(msg) then   
...
if text == 'تعطيل المغادره' and DevROGENW(msg) then  
...
-- vardump(data) 
ROGENdx(msg.chat_id_, msg.id_, ' *✫︙ايدي المجموعة » ( '..msg.chat_id_..' )*\n*✫︙عدد الادمنيه » ( '..data.administrator_count_..' )*\n*✫︙عدد المحظورين » ( '..data.kicked_count_..' )*\n*✫︙عدد الاعضاء » ( '..data.member_count_..' )*\n', 'md') 
end 
...
if text == 'استعاده الاوامر' and DevROGENW(msg) then
...
ROGEN = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(ROGEN)
...
--------------------------------------------------------------------------------------------------------------
SourceROGEN(data.message_,data)
...
------------------------------------------------------------------------
local ROGENAbot = database:get(bot_id.."ROGEN1:Add:Filter:Rp2"..text..result.chat_id_)   
if ROGENAbot then
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," *✫︙العضو :* {["..data.first_name_.."](T.ME/"..data.username_..")}\n✫︙["..ROGENAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local ROGEN1_Msg = database:get(bot_id.."ROGEN1:Add:Filter:Rp2"..text..result.chat_id_)   
if ROGEN1_Msg then
send(msg.chat_id_, msg.id_," ✫︙"..ROGEN1_Msg)
